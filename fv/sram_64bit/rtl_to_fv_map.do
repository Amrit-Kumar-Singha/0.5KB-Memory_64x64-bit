...
# Generated on: Tue Jul 16 15:33:41 IST 2024 (Tue Jul 16 10:03:41 UTC 2024)
...
set_log_file fv/sram_64bit/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/sram_64bit -revised fv_map
...
add_search_path /home/cadence/Desktop/sram/64-bit_SRAM -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/cadence/Desktop/sram/64-bit_SRAM/64_bit_SRAM.v
elaborate_design -golden -root {sram_64bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sram_64bit/fv_map.v.gz
elaborate_design -revised -root {sram_64bit}
...
#add_name_alias fv/sram_64bit/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/sram_64bit/rtl_to_fv_map.log
}
